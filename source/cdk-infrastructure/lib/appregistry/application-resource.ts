...
import { AmazonVirtualAndonStackProps } from "../amazon-virtual-andon-stack";
...
export function applyAppRegistry(stack: Stack, solutionProps: AmazonVirtualAndonStackProps) {
    //  Declare CFN Mappings
    const map = new CfnMapping(stack, "SolutionMapping", { lazy: true });
    ...
    const application = new Application(stack, "Application", {
        ...
        description: solutionProps.description ?? "Amazon Virtual Andon Description"
    });
